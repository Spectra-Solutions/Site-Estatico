...
public class MemoriaRamDao {
    ...
    public void insertDadosMemoriaRam(){
        con.update("INSERT INTO RegistroComponente (idRegistroComponente,consumoAtual, armazenamentoDisponivel, armazenamentoTotal, armazenamentoEmUso, fkComponente) VALUES (?, ?, ?, ?, ?, ?)",
                    memoriaRam.getIdRegistroMemoriaRam(), memoriaRam.getConsumoAtual(), memoriaRam.getArmazenamentoDisponivel(), memoriaRam.getArmazenamentoTotal(), memoriaRam.getArmazenamentoEmUso(), memoriaRam.getFkComponenteRAM());
    }
}
