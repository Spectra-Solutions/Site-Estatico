...
public class CPUDao {
    ...
    public void insertDadosCpu(){
        con.update("INSERT INTO RegistroComponente (idRegistroComponente, nomeCpu, consumoAtual, fkComponente) VALUES (?, ?, ?, ?)",
                  cpu.getIdRegistroCPU(), cpu.getEspecificacao(), cpu.getConsumoAtual(), cpu.getFkComponenteCPU());
    }
}
